...
class DLL_EXP_QLIB CSplitterControl : public CStatic
{
	DECLARE_DYNAMIC(CSplitterControl)
// Construction
public:
	CSplitterControl();
...
// Attributes
public:
	void setLeftSplitter(CSplitterControl *aLeft) {m_pLeft = aLeft;}
	void setRightSplitter(CSplitterControl *aRight) {m_pRight = aRight;}
protected:
	BOOL		m_bIsPressed;
	int			m_nType;
	int			m_nX, m_nY;
	...
	CSplitterControl *m_pLeft;
	CSplitterControl *m_pRight;
// Operations
public:
...
protected:
	...
	void OnMyMouseMove( CPoint point );
